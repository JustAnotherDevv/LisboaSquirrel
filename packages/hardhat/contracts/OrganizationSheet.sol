...
contract OrganizationSheet {
    ...
    function voteAllocationPeriod(uint256 organization, uint256 votePeriodIndex, uint256 criteriaIndex, string memory note, uint32 rating ) public onlySuperAdmin(organization) {
